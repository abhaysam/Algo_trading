...
class MeanRevBacktester():
    ...
    def __init__(self, symbol, SMA, dev, start, end, fees = 0, ticker = None):
        '''
        Parameters
        ----------
        symbol: str
    ...
    def test_strategy(self):
        ...
        data.trades.value_counts() #Not used, still carries important information
    ...
    def plot_results(self):
        ...
        if self.results is None:
            ...
            title = "{} | SMA = {} | dev = {} | Fees = {}".format(self.symbol, self.SMA, self.dev, self.fees)
